            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <nav class="-mx-3 flex flex-1 justify-end">
                            @auth
                                <a href="{{ url('/dashboard') }}"
                                    class="rounded-md px-3 py-2  ring-1 ring-transparent transition ocus:outline-none  text-white hover:text-white/80 focus-visible:ring-white">
                                    Dashboard
                                </a>
                            @else
                                <a href="{{ route('login') }}"
                ...
                <main class="mt-6">
                        ...
                        <a
                            ...
                            <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                <img src="https://i.ytimg.com/vi/EA0YC9m6D4s/maxresdefault.jpg"
                                    alt="Laravel documentation screenshot" style="border-radius: 20px"
                    ...
                    <div class="flex flex-wrap text-gray-300 my-32 justify-center items center">
                        ...
                        <div class="flex flex-col ring-white/50 mx-5 px-5 card" style="width: 27%;min-width: 300px">
                            <img src="{{asset('assets/icons/ic_pc.svg')}}" style="width: 20%;">
                            <h2 class="text-3xl text-red-600 my-5 font-bold">Custom Desktop Build</h2>
                            <p class="text-white text-justify" style="width:25ch">Tailor dekstop configuration based on
                        ...
                        <div class="flex flex-col ring-white/50 mx-5 px-5 card" style="width: 27%;min-width: 300px">
                            ...
                            <h2 class="text-3xl text-red-600 my-5 font-bold">Custom Configuration</h2>
                            <p class="text-white text-justify" style="width:25ch">Build your dream laptop with our
                        ...
                        <div class="flex flex-col ring-white/50 mx-5 px-5 card" style="width: 27%;min-width: 300px">
                            ...
                            <h2 class="text-3xl text-red-600 my-5 font-bold">Latest Device & Accessories</h2>
                            <p class="text-white text-justify" style="width:25ch">Explore a curated selection of latest
