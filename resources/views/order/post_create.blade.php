            ...
            <div
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <div class="content " style="border-radius: 20px; background: #0009;">
                        <div class="flex flex-col items-center justify-center relative p-10" style="height:500px">
                            ...
                            <img src="{{asset('assets/icons/ic_tick_green.svg')}}" style="height: 100px; width:auto">
                            <h2 class="text-3xl font-semibold text-white mt-10">Order successfully created</h2>
                            <br>
                            <a href="{{route('order.index')}}" class="btn m-10"> Go to Orders </a>
                        </div>
                    </div>
                </div>
