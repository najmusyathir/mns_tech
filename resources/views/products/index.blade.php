...
<x-app-layout class="font-sans antialiased dark:bg-black dark:text-white/50">
    ...
    <div class=" text-black/50 bg-black dark:text-white/50">
        <img id="background" style="z-index: 1 !important;" class="absolute -left-20 top-0 max-w-[877px]" src="{{asset('assets/images/setup.jpg')}}" alt="background_pic" />
        <div class="z-10 relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl ">

                <div class="mt-24 content flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] md:row-span-3 lg:p-10 lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 ">
                    ...
                    <div class="BS-drawer">
                        ...
                        <div class="offcanvas offcanvas-end bg-gray-900" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                            <div class="offcanvas-header">
                                <h2 class="offcanvas-title text-white text-3xl" id="offcanvasExampleLabel">Cart</h2>

                                <button type="button" style="margin-right:10px; margin-top:10px; width:35px; height:40px;" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close">
